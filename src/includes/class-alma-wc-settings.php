 ...
 * @property array  share_of_checkout_enabled Bool for share of checkout acceptance
 * @property array  share_of_checkout_enabled_date String Date when the marchand did accept the share of checkout
 */

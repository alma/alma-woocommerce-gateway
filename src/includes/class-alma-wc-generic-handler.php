...
class Alma_WC_Generic_Handler {
	...
	public function __construct() {
		...
		$this->helper_tools  = new Alma_WC_Helper_Tools();
	}
	...
	protected function inject_payment_plan_widget(
		...
		$alma_widgets_js_url = Alma_WC_Helper_Assets::get_asset_url( 'widget/js/widgets.umd.js' );
		...
		$alma_widgets_css_url = Alma_WC_Helper_Assets::get_asset_url( 'widget/css/widgets.css' );
		...
		$alma_widgets_injection_url = Alma_WC_Helper_Assets::get_asset_url( 'js/alma-widgets-inject.js' );
		...
		<div style="margin: 15px 0; max-width: 350px">
			...
			if ( $has_excluded_products ) {
				$logo_url      = Alma_WC_Helper_Assets::get_asset_url( 'images/alma_logo.svg' );

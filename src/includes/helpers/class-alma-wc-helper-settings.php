...
class Alma_WC_Helper_Settings {
	...
	public static function default_settings() {
		return array(
			...
			'selected_fee_plan'                          => Alma_WC_Helper_Constants::DEFAULT_FEE_PLAN,
			...
			'variable_product_check_variations_event'    => Alma_WC_Helper_Constants::DEFAULT_CHECK_VARIATIONS_EVENT,
	...
	public static function default_pnx_plus_4_title() {
		if ( Alma_WC_Helper_Internationalization::is_site_multilingual() ) {

...
class Alma_WC_Settings {
	...
	public static function default_settings() {
		...
		$default_settings = array(
			...
			'title_payment_method_pnx_po_edit'             => __( 'Pay in installments with Alma', 'alma-gateway-for-woocommerce' ),
			'description_payment_method_pnx'               => $payment_methods_description,
			'title_payment_method_pay_later'               => 'Buy now, Pay later with Alma',
			'title_payment_method_pay_later_po_edit'       => __( 'Buy now, Pay later with Alma', 'alma-gateway-for-woocommerce' ),
			...
			'title_payment_method_pnx_plus_4_po_edit'      => __( 'Spread your payments with Alma', 'alma-gateway-for-woocommerce' ),
			...
			'cart_not_eligible_message_gift_cards_po_edit' => __( 'Some products cannot be paid with monthly or deferred installments', 'alma-gateway-for-woocommerce' ),
			'live_api_key'                                 => '',
			'test_api_key'                                 => '',
			'environment'                                  => 'test',
			'debug'                                        => 'yes',

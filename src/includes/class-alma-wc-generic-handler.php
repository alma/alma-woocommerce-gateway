...
class Alma_WC_Generic_Handler {
	...
	protected function inject_payment_plan_widget(
		...
		$alma_widgets_js_url = 'https://cdn.jsdelivr.net/npm/@alma/widgets@2.8.0/dist/widgets.umd.js';
		...
		$alma_widgets_css_url = 'https://cdn.jsdelivr.net/npm/@alma/widgets@2.8.0/dist/widgets.min.css';

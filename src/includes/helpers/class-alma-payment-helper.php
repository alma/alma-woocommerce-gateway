...
class Alma_Payment_Helper {
	...
	public function validate_payment( $payment_id ) {
		...
		if (
			...
			if (
				...
				throw new Alma_Incorrect_Payment_Exception( $payment_id, $order->get_id(), $payment->state, $first_instalment->state );
			}
	 ...
	 * @return Alma_Order
	 *
	 * @throws Alma_Build_Order_Exception Build order issue.
	 */

 ...
 * Class OrderAdapter
 *
 * This class adapts the WC_Order object to the OrderInterface, allowing dynamic calls to WC_Order methods.
...
class OrderAdapter implements OrderInterface {
	 ...
	 * This method retrieves the items from the order and maps them to OrderLineInterface.
	 *

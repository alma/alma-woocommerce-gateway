...
const Edit = () => {
    return (
        <div {...useBlockProps()} data-testid="alma-widget-container">
            <div id="alma-widget">
                <svg width="50" height="25" viewBox="0 0 360 109" fill="none"
                ...
                <div role="listbox" aria-label="Available payment options"
                    class="_paymentPlans_v4hon_19 alma-payment-plans-eligibility-options">
                    <button type="button" role="option" aria-selected="true"
                        aria-describedby="payment-info-text" aria-label="Payment option 3x"
                        aria-disabled="false" tabindex="0"
                        class="_planButton_v4hon_29 _active_v4hon_102 alma-payment-plans-active-option _monochrome_v4hon_82">3x
                    </button>
                </div>
            </div>
            <div id="payment-info-text" class="_info_v4hon_121 alma-payment-plans-payment-info">

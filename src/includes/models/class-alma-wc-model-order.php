...
class Alma_WC_Model_Order {
	 ...
	 *
	 * @throws Alma_WC_Exception_No_Order No order.
	 */
	public function __construct( $order_id, $order_key = null ) {
		...
		if ( ! $this->order || ( $order_key && $this->get_order_key() !== $order_key ) ) {
			throw new Alma_WC_Exception_No_Order( $order_id, $order_key );
		}
	...
	public function get_total() {
		return Alma_WC_Helper_Tools::alma_wc_price_to_cents( $this->order->get_total() );
	}

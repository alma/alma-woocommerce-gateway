 ...
 * @property string enabled as wp-bool-eq (yes or no)
 * @property string debug as wp-bool-eq (yes or no)
 * @property string environment
 * @property bool fully_configured as Flag to indicate setting are fully configured by the plugin.
 * @property string selected_fee_plan as admin dashboard fee_plan in edition mode.
...
class Alma_WC_Settings {
	...
	/** @TODO populate this array dynamically from alma_client->merchant->feePlans() ? */

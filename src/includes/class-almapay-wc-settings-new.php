...
class Almapay_WC_Settings_New {
	...
	public static function default_settings() {
		return array(
			...
			'title_payment_method_pnx'                => Almapay_WC_Settings_Helper::default_pnx_title(),
			'description_payment_method_pnx'          => Almapay_WC_Settings_Helper::default_payment_description(),
			'title_payment_method_pay_later'          => Almapay_WC_Settings_Helper::default_pay_later_title(),
			'description_payment_method_pay_later'    => Almapay_WC_Settings_Helper::default_payment_description(),
			'title_payment_method_pnx_plus_4'         => Almapay_WC_Settings_Helper::default_pnx_plus_4_title(),
			'description_payment_method_pnx_plus_4'   => Almapay_WC_Settings_Helper::default_payment_description(),
			'display_cart_eligibility'                => 'yes',
			'display_product_eligibility'             => 'yes',
			'variable_product_price_query_selector'   => Almapay_WC_Settings_Helper::default_variable_price_selector(),
			'variable_product_check_variations_event' => self::DEFAULT_CHECK_VARIATIONS_EVENT,
			'excluded_products_list'                  => array(),
			'cart_not_eligible_message_gift_cards'    => Almapay_WC_Settings_Helper::default_not_eligible_cart_message(),
			'live_api_key'                            => '',
			'test_api_key'                            => '',
			'environment'                             => 'test',
			'debug'                                   => 'yes',
	...
	public function save() {
		error_log( '-----------------------------' );
		error_log( 'Almapay_WC_Settings_New::save()' );
		error_log( '-----------------------------' );
	...
	private function get_i18n( $key ) {
		...
		if ( Almapay_WC_Internationalization::is_site_multilingual() ) {
			...
			return Almapay_WC_Internationalization::get_translated_text(

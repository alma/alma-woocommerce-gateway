	...
	public static function migrationDataProvider(): array {
		return [
			...
			'titles'                                => [
				[
					'title_alma'                           => 'A title',
					'title_alma_in_page_pay_later'         => 'A second title',
					'title_blocks_alma_pay_now'            => 'A third title',
					'title_blocks_alma_in_page_pnx_plus_4' => 'A fourth title',
				],
				[
					'pnx_title_field'        => 'A title',
					'paylater_title_field'   => 'A second title',
			...
			'descriptions'                          => [
				[
					...
					'description_alma_in_page_pay_later'         => 'A second description',
					'description_blocks_alma_pay_now'            => 'A third description',
					'description_blocks_alma_in_page_pnx_plus_4' => 'A fourth description',
				],
				[
					'pnx_description_field'      => 'A description',
					'paylater_description_field' => 'A second description',
					'paynow_description_field'   => 'A third description',
					'credit_description_field'   => 'A fourth description',
					'debug'                      => 'no',

...
class Alma_Tools {
	...
	public static function is_amount_plan_key( $key ) {
		return preg_match( Alma_Constants::AMOUNT_PLAN_KEY_REGEX, $key ) > 0;
	}
	 ...
	 */
	public static function alma_usort_plans_keys( $plan_key_1, $plan_key_2 ) {
		if ( $plan_key_1 === $plan_key_2 ) {
			return 0;
		}
		$match_1 = self::alma_match_plan_key_pattern( $plan_key_1 );
		$match_2 = self::alma_match_plan_key_pattern( $plan_key_2 );
		if ( ! $match_1 || ! $match_2 ) {
			return 0;
		}
	 ...
	 * @return false|array
	 */
	public static function alma_match_plan_key_pattern( $plan_key ) {
		$matches = array();

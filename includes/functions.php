...
if ( false ) {
	...
	if ( function_exists( 'add_action' ) ) {
		add_action(
			...
			function () {
				...
				} catch ( FeePlanServiceException|FeePlanRepositoryException $e ) {
	...
	if ( function_exists( 'add_action' ) ) {
		...
		function alma_add_gateway_top_menu() {
			add_menu_page(
				L10nHelper::__( 'Alma - Réglages', 'alma-gateway-for-woocommerce' ),
				L10nHelper::__( 'Alma', 'alma-gateway-for-woocommerce' ),
				'manage_options',

...
use Alma\Woocommerce\Admin\Builders\Alma_Form_Html_Builder;

/**
 * Alma_Form_Fields_Helper.
 */
class Alma_Form_Fields_Helper {
	...
	public function init_fee_plans_fields( $default_settings ) {
		...
		$select_options   = Alma_Form_Html_Builder::generate_select_options( $this->settings_helper->allowed_fee_plans );
	...
	public function init_general_settings_fields( array $default_settings ) {
		...
		$general_settings_fields = array(
			...
			'text_fields'     => array(
				'title' => Alma_Form_Html_Builder::render_title( __( 'Edit the text displayed when choosing the payment method in your checkout.', 'alma-gateway-for-woocommerce' ) ),
				'type'  => 'title',
			),
		);
		...
		$general_settings_fields_end = array(
			...
			'excluded_products_list'      => array(
				...
				'desc_tip'    => true,
				'css'         => 'height: 150px;',
				'options'     => Alma_Form_Html_Builder::generate_categories_options(),
			),
		);

		$field_cart_not_eligible_message_gift_cards = Alma_Internationalization_Helper::generate_i18n_field(
	...
	protected function get_custom_fields_payment_method( $payment_method_name, $title, array $default_settings ) {
		...
		$field_payment_method_title = Alma_Internationalization_Helper::generate_i18n_field(
		...
		$field_payment_method_description = Alma_Internationalization_Helper::generate_i18n_field(
		...
		return array_merge(
			...
			array(
				'payment_upon_trigger_general_info' => array(
					'title' => Alma_Form_Html_Builder::render_title(

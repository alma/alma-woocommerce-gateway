...
class Alma_Shortcodes {
	 ...
	 *
	 * @param Alma_Cart_Handler $handler as cart widget handler.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param Alma_Product_Handler $handler as product widget handler.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param Alma_Product_Handler $handler Cart handler.
	 * @param array|string         $atts Shortcode attributes.
	 * @param string               $content Shortcode content ([sc]content[/sc]).
	 *
